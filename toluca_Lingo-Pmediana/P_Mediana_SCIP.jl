using JuMP, SCIP, DelimitedFiles

# Cargar la matriz de costos desde un archivo TXT
...
# Crear el modelo de optimización con SCIP
...
println("Optimizando el modelo con SCIP...")
